...
import com.example.skeleton.product.adapter.in.batch.step.ProductSaveRandomJpaStep;
...
public class ProductSaveRandomJpaJob {

    public static final String BEAN_NAME = "PRODUCT_SAVE_RANDOM_JPA_JOB";
    ...
    public Job job() {
        return jobBuilderFactory.get(BEAN_NAME)
                ...
                .start(steps.get(ProductSaveRandomJpaStep.BEAN_NAME))
                .build();
    }
}
