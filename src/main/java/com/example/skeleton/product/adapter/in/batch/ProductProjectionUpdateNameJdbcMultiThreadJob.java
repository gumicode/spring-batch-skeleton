...
import com.example.skeleton.product.adapter.in.batch.step.ProductProjectionUpdateNameJdbcMultiThreadStep;
...
/**
 * 멀티쓰레드 Projection STEP 으로 JDBC Batch write 하는 JOB
...
public class ProductProjectionUpdateNameJdbcMultiThreadJob {

    public static final String BEAN_NAME = "PRODUCT_PROJECTION_SAVE_RANDOM_JDBC_MULTI_THREAD_JOB";
    ...
    public Job job() {
        return jobBuilderFactory.get(BEAN_NAME)
                ...
                .next(steps.get(ProductProjectionUpdateNameJdbcMultiThreadStep.BEAN_NAME))
                .build();
    }
}
